...
| --- | --- | --- | --- | --- |
| Product match, exact dictation | 98.37% top-1, 100% recall@3 (n=430) | 1,405-row catalogue, 8 warehouse codes | 7/430 top-1 misses (all recovered at rank 2) | Cannot distinguish SKUs whose names differ only by data absent from dictation |
